...
class BTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 27, fontWeight: FontWeight.w500, color: Colors.black),
    ...
    /* BODY STYLING */
    bodyLarge: const TextStyle().copyWith(fontSize: 15, fontWeight: FontWeight.w500, color: Colors.black),
